...
class AppointmentService:
    ...
    async def create_appointment(
        ...
        appointment_id = await db.fetchval("""
            INSERT INTO appointments (client_id, service_id, appointment_date, total_price, total_duration, status)
            VALUES ($1, $2, $3, $4, $5, 'pending')
            RETURNING id
        """, client_id, service_id, appointment_date, total_price, total_duration)
